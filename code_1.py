...
caffe_root = '/home/prithvi/Downloads/caffe/'
...
def main():
    net = setup_model()
    i=1
    file_path = open(input_img_val + '/VOC2012/ImageSets/Main/val.txt', 'r')
    for line in file_path:
        line=line.replace('\n','')
        predict(net, input_img_val+'/VOC2012/JPEGImages/'+line+'.jpg')
        i=i+1
        if i>= MAX_IMGS:
            break
    file_path.close()
